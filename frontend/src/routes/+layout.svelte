...
<svelte:head>
  ...
  <meta
    name="description"
    content="BookHaven — учебная АИС книжного магазина для просмотра и управления книгами"
  />
</svelte:head>

{#if $navigating}
  <div class="fixed inset-x-0 top-0 z-50 h-1 bg-brass" aria-hidden="true"></div>
{/if}
